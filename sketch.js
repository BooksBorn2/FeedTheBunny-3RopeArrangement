...
var button,blower,button_2
var bunny;
var blink,eat,sad;
var mute_btn;

var fr,rope_2;
var rope_3,link_3,button_3
...
function setup() {
  ...
  rope_2 = new Rope(7,{x:400,y:40})
  link_2 = new Link(rope_2,fruit)

  button_2 = createImg('cut_btn.png');
  button_2.position(380,40);
  button_2.size(50,50);
  button_2.mouseClicked(drop_2);
  
  rope_3 = new Rope(7,{x:100,y:50})
  link_3 = new Link(rope_3,fruit)

  button_3 = createImg('cut_btn.png');
  button_3.position(80,50);
  button_3.size(50,50);
